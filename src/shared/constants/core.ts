...
/** Indicates whether the environment is production, based on the `NODE_ENV` environment variable. */
export const IS_PROD = $NODE_ENV === "production";
/** Indicates whether the environment is development, based on the `NODE_ENV` environment variable. */
